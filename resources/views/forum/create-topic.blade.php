                ...
                <div class="bg-white dark:bg-gray-800 shadow-lg sm:rounded-xl overflow-hidden">
                    <div class="relative bg-unimasblue dark:bg-unimasblue p-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('forum.index', $event->id) }}" class="inline-flex items-center px-3 py-2 bg-white/10 hover:bg-white/20 text-white text-sm font-medium rounded-lg transition duration-300">
                    ...
                    <div class="p-4 sm:p-6 md:p-8">
                        <form action="{{ route('forum.store-topic', $event->id) }}" method="POST">
                            ...
                            <div class="mb-6">
                                <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Question Title</label>
                                <input type="text" id="title" name="title" value="{{ old('title') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-unimasblue focus:border-unimasblue block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-unimasblue dark:focus:border-unimasblue" placeholder="e.g. What time does check-in start?" required>
                                @error('title')
                            ...
                            <div class="mb-6">
                                <label for="content" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Question Details</label>
                                <textarea id="content" name="content" rows="6" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-unimasblue focus:border-unimasblue block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-unimasblue dark:focus:border-unimasblue" placeholder="Provide more details about your question here..." required>{{ old('content') }}</textarea>
                                @error('content')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="flex justify-end mt-6">
                                <a href="{{ route('forum.index', $event->id) }}" class="px-4 py-2 mr-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 dark:bg-transparent dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700">
                                    Cancel
                                </a>
