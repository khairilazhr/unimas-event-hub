                                                ...
                                                <div class="flex-1">
                                                    <div class="flex justify-between items-start mb-4">
                                                        ...
                                                        <div class="w-24 flex-shrink-0">
                                                            <span class="px-3 py-1 inline-flex justify-center w-full text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100">
                                                                Attended
                                                            </span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                                                        <div>
                                                            <span class="block text-gray-500 dark:text-gray-400 font-medium">Event Date</span>
                                                            <span class="text-gray-900 dark:text-white">
                                                                {{ \Carbon\Carbon::parse($attendance->eventRegistration->event->date)->format('d M Y, h:i A') }}
                                                            </span>
                                                        </div>
                                                        <div>
                                                            <span class="block text-gray-500 dark:text-gray-400 font-medium">Attended At</span>
                                                            <span class="text-gray-900 dark:text-white">
