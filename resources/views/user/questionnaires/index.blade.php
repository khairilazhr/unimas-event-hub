                        ...
                        @else
                            <div class="grid gap-6">
                                @foreach($questionnaires as $questionnaire)
                                    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 hover:shadow-md transition-shadow duration-300">
                                        <div class="flex justify-between items-start">
                                            <div class="flex-1">
                                                ...
                                                @php
                                                    $hasResponded = \App\Models\QuestionResponse::whereIn('question_id', $questionnaire->questions->pluck('id'))
