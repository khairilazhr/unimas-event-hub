...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>A refund request has been submitted for your event ticket.</p>
        </div>
        <div style="text-align: center;">
            <span class="notification-badge">Refund Request</span>
        </div>
        ...
        <div class="refund-info">
            ...
            <div class="detail-row"><span class="detail-label">Requested By:</span><span
                    class="detail-value">{{ $user->name }} ({{ $user->email }})</span></div>
