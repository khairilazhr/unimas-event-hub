        ...
        <main class="flex-grow py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
                ...
                <div class="text-center">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Your monthly overview, events, and resources</p>
                </div>

                <!-- Calendar Widget -->
                <div class="rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 overflow-hidden">
                    ...
                    <div class="p-6 bg-gray-50 dark:bg-gray-950">
                        ...
                        <div class="grid grid-cols-7 gap-1 text-xs text-center">
                            ...
                            @for ($day = 1; $day <= $daysInMonth; $day++)
                                ...
                                <div class="p-2 rounded-md transition-all {{ $isToday ? 'bg-indigo-100 dark:bg-indigo-600 font-semibold text-indigo-900 dark:text-white' : 'hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300' }}">
                                    <div>{{ $day }}</div>
                                    @if($eventText)
                    ...
                    <!-- Calendar Legend -->
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between px-6 py-4 border-t border-gray-200 dark:border-gray-700 text-xs text-gray-500 dark:text-gray-400 gap-3">
                ...
                <!-- Announcement Block -->
                <div class="bg-white dark:bg-gray-900 border-l-4 border-indigo-500 rounded-xl shadow-md p-5">
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-1">Announcements</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Stay updated with the latest news and activities.</p>
                </div>
                    ...
                    @foreach (range(1, 2) as $index)
                        <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                            <div class="flex flex-col md:flex-row">
                                <div class="md:w-1/4 flex items-center justify-center bg-gray-100 dark:bg-gray-800 p-4">
