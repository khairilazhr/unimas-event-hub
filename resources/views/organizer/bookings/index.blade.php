                ...
                <div class="bg-white dark:bg-gray-800 shadow-lg sm:rounded-xl overflow-hidden">
                    ...
                    <div class="p-4 sm:p-6 md:p-8">
                        ...
                        <div class="mb-6">
                            ...
                            <select id="eventFilter" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700" id="bookingsTable">
                                    @forelse($registrations as $registration)
                                        <tr class="booking-row"
                                            data-event-id="{{ $registration->event->id }}"
                                            data-status="{{ $registration->status }}">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900 dark:text-white">{{ $registration->event->name }}</div>
                                                <div class="text-sm text-gray-500 dark:text-gray-400">{{ date('M d, Y', strtotime($registration->event->date)) }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900 dark:text-white">{{ $registration->ticket->type }}</div>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                @if($registration->user)
                                                    <div class="text-sm text-gray-500 dark:text-gray-400">User ID: {{ $registration->user->id }}</div>
                                                @else
                                                    <div class="text-sm text-gray-500 dark:text-gray-400">Guest Registration</div>
                                                @endif
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900 dark:text-white">{{ $registration->email }}</div>
                                                <div class="text-sm text-gray-500 dark:text-gray-400">{{ $registration->phone }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900 dark:text-white">{{ date('M d, Y', strtotime($registration->created_at)) }}</div>
                                                <div class="text-sm text-gray-500 dark:text-gray-400">{{ date('h:i A', strtotime($registration->created_at)) }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
