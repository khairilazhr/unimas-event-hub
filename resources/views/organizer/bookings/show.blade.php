                    ...
                    <div class="p-4 sm:p-6 md:p-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <dl class="space-y-2">
                                    <div>
                                        ...
                                        <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                                            {{ $registration->event->name }}</dd>
                                    </div>
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Event Date</dt>
                                        <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                                            {{ \Carbon\Carbon::parse($registration->event->date)->format('M d, Y') }}
                                        </dd>
                                    </div>
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Location</dt>
                                        <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                                            {{ $registration->event->location }}</dd>
                                    </div>
                                </dl>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                                ...
                                <dl class="space-y-2">
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Ticket Type
                                        </dt>
                                        <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                                            {{ $registration->ticket->type }}</dd>
                                    </div>
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Seat Details
                                        </dt>
                                        <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                                ...
                                <dl class="space-y-2">
                                    <div>
                                        ...
                                        <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                                            {{ $registration->name }}</dd>
                                    </div>
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Email</dt>
                                        <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                                            {{ $registration->email }}</dd>
                                    </div>
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Phone</dt>
                                        <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                                            {{ $registration->phone }}</dd>
                                    </div>
                                    @if ($registration->user)
                                        <div>
                                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">User ID
                                            </dt>
                                            <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                                                {{ $registration->user->id }}</dd>
                                        </div>
                                    @endif
                                </dl>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                                ...
                                <dl class="space-y-2">
                                            ...
                                            <dd class="mt-1">
                                                ...
                                                <div class="flex items-center space-x-2">
                                                    @if ($exists && $fileUrl)
                                                        ...
                                                        <span
                                                            class="px-2 py-1 bg-red-100 text-red-800 rounded-full text-xs uppercase">
                                                            {{ $extension }}
                                                        </span>
                                                    @else
                                                        <span class="text-sm text-gray-500">Receipt file not found
                                                            ({{ $receipt }})</span>
                                                    @endif
                                                </div>
                                            </dd>
                                    ...
                                    @else
                                        <div>
                                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Receipt
                                            </dt>
                        ...
                        @if ($registration->status == 'pending')
                            <div
                                class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700 flex justify-end space-x-4">
                                <form action="{{ route('organizer.approve.booking', $registration->id) }}"
                                    method="POST">
                                    @csrf
                                    <button type="submit"
                                ...
                                <form action="{{ route('organizer.reject.booking', $registration->id) }}"
                                    method="POST">
                                    @csrf
                                    <button type="submit"
