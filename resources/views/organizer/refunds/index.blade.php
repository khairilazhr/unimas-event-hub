                                                ...
                                                @foreach ($eventRefunds as $refund)
                                                    <tr data-status="{{ $refund->status }}">
                                                        ...
                                                        <td class="px-4 py-4">
                                                            ...
                                                            <div class="text-sm text-gray-500 dark:text-gray-400">
                                                                Section {{ $refund->ticket->section }} - Row
                                                                {{ $refund->ticket->row }} - Seat
                                                                {{ $refund->ticket->seat }}
                                                            </div>
                                                        </td>
                                                        <td class="px-4 py-4">
                                                        ...
                                                        <td class="px-4 py-4">
                                                            <span
                                                                ...
                                                                @if ($refund->status == 'approved') bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100
        ...
        <template x-teleport="body">
            <div x-show="show" x-cloak class="fixed inset-0 z-50 overflow-y-auto"
                ...
                <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    <!-- Backdrop -->
                    <div x-show="show" @click="closeModal()" class="fixed inset-0 transition-opacity"
                        x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0"
                        x-transition:enter-end="opacity-100" x-transition:leave="ease-in duration-200"
                        x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                    ...
                    <!-- Modal content -->
                    <div x-show="show" @click.outside="closeModal()"
                                ...
                                <div class="sm:flex sm:items-start">
                                    <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                        <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white"
                                            x-text="action === 'approved' ? 'Approve Refund' : 'Reject Refund'"></h3>
                                        <div class="mt-2">
                                            <textarea name="notes" rows="4"
                                                class="shadow-sm block w-full focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700 dark:text-white"
                                        ...
                                        <div class="mt-4" x-show="action === 'approved'">
                                            <label
                                                ...
                                                Refund Proof (Image or PDF) <span class="text-red-500">*</span></label>
