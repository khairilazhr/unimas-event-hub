                                            ...
                                            <div class="flex flex-col lg:flex-row min-h-[120px]">
                                                ...
                                                <div class="flex-1">
                                                    <div class="flex justify-between items-start mb-4">
                                                        ...
                                                        <div class="w-24 flex-shrink-0">
                                                            <span
                                                                ...
                                                                @if ($questionnaire->published_at) bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100
                                                                @else
                                                    ...
                                                    <div
                                                        ...
                                                        <div>
                                                            <span
                                                                class="block text-gray-500 dark:text-gray-400 font-medium">Questions</span>
                                                        ...
                                                        <div>
                                                            <span
                                                                class="block text-gray-500 dark:text-gray-400 font-medium">Responses</span>
                                                            <span class="text-gray-900 dark:text-white">
                                                                {{ $questionnaire->questions->flatMap->responses->unique('user_id')->count() }}
                                                                responses
                                                            </span>
                                                        </div>
                                                        <div>
                                                ...
                                                <div class="lg:w-48 flex-shrink-0 lg:ml-6 mt-4 lg:mt-0">
                                                    <div class="flex flex-col gap-2">
                                                        ...
                                                        @else
                                                            <form
                                                                action="{{ route('organizer.questionnaires.publish', $questionnaire) }}"
                                                                method="POST">
                                                                @csrf
                                                                <button type="submit"
                                                                    class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium rounded-lg text-green-600 bg-green-50 hover:bg-green-100 dark:text-green-400 dark:bg-green-900/20 dark:hover:bg-green-900/30 transition-colors w-full">
